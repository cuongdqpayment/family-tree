...
export class ApiStorageService {
    ...
    // public static authServer = 'http://localhost:9235/api';
    public static authServer = 'https://c3.mobifone.vn/api';
    
    public static mediaServer = 'https://c3.mobifone.vn/media/db'; 
    // public static mediaServer = 'http://localhost:9234/media/db'; 

    // public static resourceServer = 'http://localhost:9234/media/db';
    // public static newsServer = 'http://localhost:9234/media/news';

    public static resourceServer = 'https://c3.mobifone.vn/media/db';
    public static newsServer = 'https://c3.mobifone.vn/media/news';
